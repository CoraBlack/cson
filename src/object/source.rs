//! Source-file abstraction used by the compiler stage.
...
impl Source {
    /// Create source from absolute path, or from project-relative path.
    pub fn new(src_path: &Path, project_dir: &Path) -> Self {
